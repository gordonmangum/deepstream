...
FlowRouter.route("/", {
  ...
  this.register('currentDeepstreamContext', Meteor.subscribe('deepstreamContext', 'SEDsDRNb')); //this allows us to have context blocks for everythig in home.js but only returns context blocks (regardless of short id given) with SEDsDRNb short id.
  },
