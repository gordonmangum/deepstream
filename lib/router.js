...
FlowRouter.route("/watch/:userPathSegment/:streamPathSegment", {
  ...
  action (params) {
    ...
    BlazeLayout.render("watch_page", {onCuratePage: false, userPathSegment: params.userPathSegment, streamPathSegment: params.streamPathSegment, shortId: shortId});
  },
...
FlowRouter.route("/curate/:userPathSegment/:streamPathSegment", {
  ...
  action (params) {
    setMetaDescription();
    var shortId = idFromPathSegment(params.streamPathSegment);
    BlazeLayout.render("watch_page", {onCuratePage: true, userPathSegment: params.userPathSegment, streamPathSegment: params.streamPathSegment, shortId: shortId});
  },
  subscriptions: function(params) {
    var shortId = idFromPathSegment(params.streamPathSegment);
    this.register('currentDeepstreamContext', Meteor.subscribe('deepstreamContext', shortId));
