...
setMetaDescription = function(desc){
  if (Meteor.isClient){
    if (desc){
      ...
      $('meta[name="description"]').attr('content', 'Transforming the livestream experience');
      $('meta[property="og:description"]').attr('content', 'Transforming the livestream experience');
      $('meta[name="twitter:description"]').attr('content', 'Transforming the livestream experience');
    }
  }
};
...
FlowRouter.route("/recover-password", {
  ...
  action () {
    ...
    setMetaDescription();
    setStatusCode();
    FlowLayout.render("recover_password");
  },
  triggersEnter: [function(){
    $('html, body').scrollTop(0);
  }]
...
FlowRouter.route("/reset-password/:resetPasswordToken", {
  ...
  action (params) {
    ...
    return FlowLayout.render("reset_password");
  },
  triggersEnter: [function(){
    $('html, body').scrollTop(0);
  }]
