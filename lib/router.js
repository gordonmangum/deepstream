...
FlowRouter.route("/watch/:userPathSegment/:streamPathSegment", {
  ...
  action (params, queryParams) {
    ...
    BlazeLayout.render("watch_page", {onCuratePage: false, userPathSegment: params.userPathSegment, streamPathSegment: params.streamPathSegment, shortId: shortId, curatorInviteCode: queryParams.curatorInviteCode});
  },
...
FlowRouter.route("/curate/:userPathSegment/:streamPathSegment", {
  ...
  action (params, queryParams) {
    setMetaDescription();
    var shortId = idFromPathSegment(params.streamPathSegment);
    BlazeLayout.render("watch_page", {onCuratePage: true, userPathSegment: params.userPathSegment, streamPathSegment: params.streamPathSegment, shortId: shortId, curatorInviteCode: queryParams.curatorInviteCode});
  },
  subscriptions: function(params) {
    var shortId = idFromPathSegment(params.streamPathSegment);
    this.register('currentDeepstreamContext', Meteor.subscribe('deepstreamContext', shortId));
