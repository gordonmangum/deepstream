...
addContextToStream =  function (streamShortId, contextBlock) {
  ...
  var user = Meteor.users.findOne({_id: this.userId}, {fields: {'username': 1, '_id': 0}});
  ...
  var contextBlockToInsert = _.extend({}, _.omit(contextBlock, '_id'), {
    ...
    authorId: contextBlock.authorId || this.userId,
    suggestedAt: contextBlock.suggestedAt || now,
    suggestedBy: contextBlock.suggestedBy || this.userId,
    suggestedByUsername: contextBlock.suggestedByUsername || user.username,
