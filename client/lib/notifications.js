...
window.notifyCard = function(cardDataObject){
  $.amaran({
      ...
      return '<div class="card-notification-container context-mini-preview" data-context-id="'+ data.CDO.cardId +'"> <div class="row"> <div class="col-xs-3"><img src="' + data.CDO.image+'"/></div> <div class="col-xs-9" style="padding-left: 0;"><p>' + data.CDO.message + '</p></div> </div> </div>';
      },
      //sticky: true,
      //clearAll: true
    }
